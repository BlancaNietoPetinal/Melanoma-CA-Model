...
int main(){
    ...
    int node;
    int *node_boundary;
    string FolderPath = "Tests/fem_resultados/";
    string node_txt_file_name = FolderPath + "rectangle_nodes.txt";
    string time_file_name = FolderPath + "rectangle_time.txt";
    string triangulation_txt_file_name = FolderPath + "rectangle_elements.txt";
    bool node_label;
    int node_show;
